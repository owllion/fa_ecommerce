...
from . import auth_router, product_router, review_router, user_router
...
#user
router.include_router(user_router.protected_plural)
router.include_router(user_router.protected_singular)
router.include_router(user_router.public_plural)
